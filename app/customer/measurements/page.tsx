...
const measurementVideoLinks: Partial<Record<MeasurementFieldKey, MeasurementVideoLink>> = {
  ...
  wrist: 'https://ewfttdrfsdhgslldfgmz.supabase.co/storage/v1/object/public/tutorial-videos/wrist.mp4',
  ...
  ankle_width: 'https://ewfttdrfsdhgslldfgmz.supabase.co/storage/v1/object/public/tutorial-videos/ankle.mp4',
